...
class Record final :
 ...
 public:
  ...
  bool has_linework() const;
  private:
  bool _internal_has_linework() const;
  public:
  void clear_linework();
  const std::string& linework() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_linework(ArgT0&& arg0, ArgT... args);
  std::string* mutable_linework();
  PROTOBUF_NODISCARD std::string* release_linework();
  void set_allocated_linework(std::string* linework);
  private:
  const std::string& _internal_linework() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_linework(const std::string& value);
  std::string* _internal_mutable_linework();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr linework_;
    int32_t year_;
    bool international_;
  };
  union { Impl_ _impl_; };
...
// optional string lineWork = 4;
inline bool Record::_internal_has_linework() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool Record::has_linework() const {
  return _internal_has_linework();
}
inline void Record::clear_linework() {
  _impl_.linework_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline const std::string& Record::linework() const {
  // @@protoc_insertion_point(field_get:Record.lineWork)
  return _internal_linework();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Record::set_linework(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.linework_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Record.lineWork)
}
inline std::string* Record::mutable_linework() {
  std::string* _s = _internal_mutable_linework();
  // @@protoc_insertion_point(field_mutable:Record.lineWork)
  return _s;
}
inline const std::string& Record::_internal_linework() const {
  return _impl_.linework_.Get();
}
inline void Record::_internal_set_linework(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.linework_.Set(value, GetArenaForAllocation());
}
inline std::string* Record::_internal_mutable_linework() {
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.linework_.Mutable(GetArenaForAllocation());
}
inline std::string* Record::release_linework() {
  // @@protoc_insertion_point(field_release:Record.lineWork)
  if (!_internal_has_linework()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.linework_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.linework_.IsDefault()) {
    _impl_.linework_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void Record::set_allocated_linework(std::string* linework) {
  if (linework != nullptr) {
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000004u;
  }
  _impl_.linework_.SetAllocated(linework, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.linework_.IsDefault()) {
    _impl_.linework_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Record.lineWork)
}

// optional bool international = 5;
inline bool Record::_internal_has_international() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Record::has_international() const {
  return _internal_has_international();
}
inline void Record::clear_international() {
  _impl_.international_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Record::_internal_international() const {
  return _impl_.international_;
}
inline bool Record::international() const {
  // @@protoc_insertion_point(field_get:Record.international)
  return _internal_international();
}
inline void Record::_internal_set_international(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.international_ = value;
}
inline void Record::set_international(bool value) {
  _internal_set_international(value);
  // @@protoc_insertion_point(field_set:Record.international)
}
